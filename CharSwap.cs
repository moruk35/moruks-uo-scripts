...
namespace Server.Gumps
{
	public class CharacterControlGump : Gump
	{
		...
		{
			Server.Commands.Register( "CharControl", AccessLevel.Administrator, new CommandEventHandler( CharControl_OnCommand ) );
		}
		[Usage( "CharControl" )]
		...
		{
			return ( a == null || !(Accounts.Table.Contains( a.Username )) );
		}
